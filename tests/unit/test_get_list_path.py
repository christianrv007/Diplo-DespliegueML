...
def get_parameters():
    return [("todos",todos.PATH_TO_DATA + "todos.csv")]

@pytest.mark.parametrize("path, expected", get_parameters())
def test_get_list_path(path: str, expected: str):
    assert todos.get_list_path(path) == expected