...
@pytest.mark.parametrize("filename, expected", get_parameters())
def test_get_filename(filename: str, expected : str) -> None:
    assert todos.get_list_filename(filename) == expected