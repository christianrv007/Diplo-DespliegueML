...
@pytest.mark.parametrize("list", get_parameters())
def test_check_list_exists_fail(list: str) -> None:
    assert todos.check_list_exists(list) == False

@pytest.mark.parametrize("list", get_parameters())
def test_check_list_exists(list: str) -> None:
    assert todos.check_list_exists(list) == True